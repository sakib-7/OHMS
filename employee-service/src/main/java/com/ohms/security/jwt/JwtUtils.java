...
//  
//  import com.ohms.security.services.UserDetailsImpl; import io.jsonwebtoken.*;
...
//  
//  @Value("${ohms.app.jwtSecret}") private String jwtSecret;
//  
//  @Value("${ohms.app.jwtExpirationMs}") private int jwtExpirationMs;
//  
